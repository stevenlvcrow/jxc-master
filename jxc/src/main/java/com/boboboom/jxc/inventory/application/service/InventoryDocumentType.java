...
public enum InventoryDocumentType {
    ...
    STORE_TRANSFER("store-transfer", "STORE_TRANSFER", "店间调拨", "DJDB", "/inventory/store-transfers/view/", false, StockDirection.NONE),
    STOCK_TRANSFER_OUTBOUND("stock-transfer-outbound", "STOCK_TRANSFER_OUTBOUND", "移库出库", "YKCK", "/inventory/stock-transfer-outbounds/view/", false, StockDirection.NONE);
