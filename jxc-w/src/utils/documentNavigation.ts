...
const DOCUMENT_ROUTE_BY_PREFIX: Record<string, DocumentRouteConfig> = {
  ...
  PY: { path: '/inventory/profit-inbounds', queryKey: 'documentCode' },
  PK: { path: '/inventory/loss-outbounds', queryKey: 'documentCode' },
...
const DOCUMENT_ROUTE_BY_TYPE: Record<string, DocumentRouteConfig> = {
  ...
  盘盈单: { path: '/inventory/profit-inbounds', queryKey: 'documentCode' },
  盘亏单: { path: '/inventory/loss-outbounds', queryKey: 'documentCode' },
