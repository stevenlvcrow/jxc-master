...
export const inventoryRoutes: RouteRecordRaw[] = [
  ...
  {
          path: 'inventory/profit-inbounds/create',
          name: 'ProfitInboundCreate',
          component: () => import('@/views/inventory/profit-inbound-create.vue'),
          meta: {
            title: '新增盘盈单',
            activeMenu: '/inventory/profit-inbounds',
            breadcrumbs: ['库存管理', '盘点管理', '盘盈单', '新增盘盈单'],
            openKeys: ['m4', 'm4-m2'],
          },
        },
  {
          path: 'inventory/profit-inbounds/view/:id',
          name: 'ProfitInboundView',
          component: () => import('@/views/inventory/profit-inbound-create.vue'),
          meta: {
            title: '查看盘盈单',
            activeMenu: '/inventory/profit-inbounds',
            breadcrumbs: ['库存管理', '盘点管理', '盘盈单', '查看盘盈单'],
            openKeys: ['m4', 'm4-m2'],
          },
        },
  {
          path: 'inventory/profit-inbounds/edit/:id',
          name: 'ProfitInboundEdit',
          component: () => import('@/views/inventory/profit-inbound-create.vue'),
          meta: {
            title: '编辑盘盈单',
            activeMenu: '/inventory/profit-inbounds',
            breadcrumbs: ['库存管理', '盘点管理', '盘盈单', '编辑盘盈单'],
            openKeys: ['m4', 'm4-m2'],
          },
        },
  {
          path: 'inventory/loss-outbounds/create',
          name: 'LossOutboundCreate',
          component: () => import('@/views/inventory/loss-outbound-create.vue'),
          meta: {
            title: '新增盘亏单',
            activeMenu: '/inventory/loss-outbounds',
            breadcrumbs: ['库存管理', '盘点管理', '盘亏单', '新增盘亏单'],
            openKeys: ['m4', 'm4-m2'],
          },
        },
  {
          path: 'inventory/loss-outbounds/view/:id',
          name: 'LossOutboundView',
          component: () => import('@/views/inventory/loss-outbound-create.vue'),
          meta: {
            title: '查看盘亏单',
            activeMenu: '/inventory/loss-outbounds',
            breadcrumbs: ['库存管理', '盘点管理', '盘亏单', '查看盘亏单'],
            openKeys: ['m4', 'm4-m2'],
          },
        },
  {
          path: 'inventory/loss-outbounds/edit/:id',
          name: 'LossOutboundEdit',
          component: () => import('@/views/inventory/loss-outbound-create.vue'),
          meta: {
            title: '编辑盘亏单',
            activeMenu: '/inventory/loss-outbounds',
            breadcrumbs: ['库存管理', '盘点管理', '盘亏单', '编辑盘亏单'],
            openKeys: ['m4', 'm4-m2'],
          },
        },
  {
