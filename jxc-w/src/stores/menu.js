...
import { fetchCurrentMenusApi } from '@/api/modules/menu';
...
export const useMenuStore = defineStore('menu', () => {
    ...
    const loadedOrgId = ref('');
    const rawMenus = ref([]);
    const menuItems = computed(() => buildMenuTree(rawMenus.value));
    const loadMenus = async (orgId) => {
