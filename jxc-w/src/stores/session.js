...
const normalizeOrgId = (rawId, type) => {
...
export const useSessionStore = defineStore('session', () => {
    ...
    const isLoggedIn = ref(useRealAuthApi ? Boolean(accessToken.value) : localStorage.getItem(STORAGE_LOGIN_KEY) === '1');
    const userName = ref('李智杰');
    const orgTree = ref(normalizeOrgTree(defaultOrgTree));
    ...
    const login = (name = '李智杰', account = '', options = {}) => {
