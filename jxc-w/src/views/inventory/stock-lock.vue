...
<template>
  <section class="panel item-main-panel">
    <CommonQuerySection :model="query">
      <el-form-item label="锁库日期">
        <el-date-picker
          v-model="query.lockDateRange"
          type="daterange"
      ...
      <el-form-item label="物品">
        <el-select v-model="query.itemName" clearable style="width: 140px">
    ...
    <div class="table-toolbar">
      <el-button type="primary" @click="handleToolbarAction('锁库')">
        <el-icon><Lock /></el-icon>
        锁库
      </el-button>
      <el-button @click="handleToolbarAction('解锁')">
        <el-icon><Unlock /></el-icon>
        解锁
      </el-button>
      <el-button @click="handleToolbarAction('批量锁库')">批量锁库</el-button>
      <el-button @click="handleToolbarAction('批量解锁')">批量解锁</el-button>
    ...
    >
      ...
      <el-table-column prop="stockUnitQty" label="库存单位锁库数量" min-width="160" show-overflow-tooltip />
      <el-table-column prop="baseUnit" label="基准单位" min-width="100" show-overflow-tooltip />
      <el-table-column prop="baseUnitQty" label="基准单位锁库数量" min-width="160" show-overflow-tooltip />
      <el-table-column prop="lockReason" label="锁库原因" min-width="120" show-overflow-tooltip />
      <el-table-column prop="lockDate" label="锁库日期" min-width="110" show-overflow-tooltip />
