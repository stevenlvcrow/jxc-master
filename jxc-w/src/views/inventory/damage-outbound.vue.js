...
if (!__VLS_ctx.filtersCollapsed) {
    ...
    const __VLS_68 = __VLS_asFunctionalComponent(__VLS_67, new __VLS_67({
        modelValue: (__VLS_ctx.query.damageReason),
        clearable: true,
        ...{ style: {} },
    }));
    ...
    for (const [option] of __VLS_getVForSourceType((__VLS_ctx.damageReasonOptions))) {
...
let __VLS_237;
const __VLS_238 = {
    onCommand: (__VLS_ctx.handleExportCommand)
};
...
var __VLS_242;
{
    const { dropdown: __VLS_thisSlot } = __VLS_234.slots;
    const __VLS_251 = {}.ElDropdownMenu;
...
{
    const { default: __VLS_thisSlot } = __VLS_326.slots;
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            damageReasonOptions: damageReasonOptions,
