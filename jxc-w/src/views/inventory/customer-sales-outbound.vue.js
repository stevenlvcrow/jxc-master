...
const __VLS_28 = __VLS_asFunctionalComponent(__VLS_27, new __VLS_27({
    modelValue: (__VLS_ctx.query.customer),
    data: (__VLS_ctx.customerTree),
...
const __VLS_72 = __VLS_asFunctionalComponent(__VLS_71, new __VLS_71({
    modelValue: (__VLS_ctx.query.salesPerson),
    data: (__VLS_ctx.salesTree),
    props: ({ label: 'label', value: 'value', children: 'children' }),
    clearable: true,
    checkStrictly: true,
    defaultExpandAll: true,
...
var __VLS_234;
{
    const { dropdown: __VLS_thisSlot } = __VLS_226.slots;
    const __VLS_243 = {}.ElDropdownMenu;
