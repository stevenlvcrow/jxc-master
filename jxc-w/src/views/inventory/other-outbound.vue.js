...
if (!__VLS_ctx.filtersCollapsed) {
    ...
    const __VLS_79 = {}.ElTreeSelect;
    /** @type {[typeof __VLS_components.ElTreeSelect, typeof __VLS_components.elTreeSelect, ]} */ ;
    // @ts-ignore
    const __VLS_80 = __VLS_asFunctionalComponent(__VLS_79, new __VLS_79({
        modelValue: (__VLS_ctx.query.outboundReason),
        data: (__VLS_ctx.outboundReasonTree),
        props: ({ label: 'label', value: 'value', children: 'children' }),
        clearable: true,
        checkStrictly: true,
        defaultExpandAll: true,
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            outboundReasonTree: outboundReasonTree,
            query: query,
