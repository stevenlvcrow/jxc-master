...
for (const [option] of __VLS_getVForSourceType((__VLS_ctx.salesOptions))) {
...
var __VLS_250;
{
    const { dropdown: __VLS_thisSlot } = __VLS_242.slots;
    const __VLS_259 = {}.ElDropdownMenu;
