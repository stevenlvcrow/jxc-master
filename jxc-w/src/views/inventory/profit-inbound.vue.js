...
const timeTypeOptions = ['单据日期', '创建时间'];
...
const __VLS_52 = __VLS_asFunctionalComponent(__VLS_51, new __VLS_51({
    modelValue: (__VLS_ctx.query.sourceCode),
    placeholder: "请输入来源单号",
    clearable: true,
    ...{ style: {} },
}));
...
const __VLS_84 = __VLS_asFunctionalComponent(__VLS_83, new __VLS_83({
    modelValue: (__VLS_ctx.query.thirdPartyCode),
    placeholder: "请输入第三方单据号",
    clearable: true,
    ...{ style: {} },
}));
...
var __VLS_226;
{
    const { dropdown: __VLS_thisSlot } = __VLS_218.slots;
    const __VLS_235 = {}.ElDropdownMenu;
    ...
    const __VLS_239 = {}.ElDropdownItem;
